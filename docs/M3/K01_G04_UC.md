...
| Revisi | Deskripsi                                                                                                                               |
| ------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| REV-M3-01 | Menambahkan kebutuhan pengguna awal, deskripsi aktivitas, kebutuhan, dan kebutuhan fungsional untuk autentikasi melalui akun Google (US-09, A-11, R-21, KF-20) yang sebelumnya belum tercakup dalam dokumen |
| ...    |                                                                                                                                         |
...
| KF-20 | R-21 | Sistem dapat memverifikasi identitas pengguna melalui login akun Google dan memberikan akses ke aplikasi setelah autentikasi berhasil. |
