...
## 3.3 _Use Case_ Diagram

Buatlah diagram _use case_ keseluruhan berdasarkan identifikasi _use case_ beserta aktor yang melakukan _use case_ tersebut. Perhatikan garis `<<extend>>` dan `<<include>>`.

Pada bagian ini, Anda diperbolehkan untuk menyalin dari dokumen sebelumnya.

<br>
<p align="center">
<img alt="_Use Case_ Diagram" src="../M4/assets/diagram/contoh-uc-diagram.webp" width="80%">
</p>
<p align="center">
<i>Gambar 1. _Use Case_ Diagram</i>
</p>
<br>

## 3.4 Skenario _Use Case_
...
| C-15     | Status_Server_        | Merepresentasikan status _uptime_ layanan yang dipantau Administrator.                                                        | UC-10                                   |

## 4.2 Diagram Kelas per _Use Case_

### 4.2.1 _Use Case_ UC-01
...
| -------- | -------------- | -------------------------------------------------------------------------- |
| C-03     | Administrator  | Merealisasikan Pengguna; mengelola jadwal konsultan, FAQ, dan umpan balik. |
| C-15     | Status_Server_ | Merepresentasikan status _uptime_ layanan yang dipantau Administrator.     |
...
Gabungkan seluruh kelas dan hubungan antarkelas dari diagram kelas setiap _use case_ menjadi satu diagram kelas keseluruhan. Pastikan tidak ada kelas yang terduplikasi.
