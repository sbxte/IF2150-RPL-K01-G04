...
| -------- | ------------- | -------------------------------------------------------------------------- |
| C-03     | Administrator | Merealisasikan Pengguna; mengelola jadwal konsultan, FAQ, dan umpan balik. |
| C-15     | StatusServer  | Merepresentasikan status _uptime_ layanan yang dipantau Administrator.     |
...
### 4.2.12 Use Case UC-12

**Nama Use Case:** Form Pengajuan Pertanyaan
...
<p align="center">
<i>Gambar 13. Diagram Kelas Use Case UC-12</i>
</p>
<br>
